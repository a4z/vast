...
const char* explanations[] = {
  // v0 -> v1
  "The dedicated `port` type was removed from VAST and replaced by a typedef"
  " for count. To update, adjust all custom schemas containing a field of type"
  " 'port' and reimport all data that contained a 'port' field.",
};
